    ...
    >
      <div className="p-12 flex flex-col h-full z-10">
        <div className="flex justify-between items-start mb-10">
          <span className="text-[11px] font-bold tracking-[0.3em] uppercase text-black/20">BRIQUE {brique.id.toString().padStart(2, '0')}</span>
        ...
        <p className="text-[#86868b] text-xl font-medium mb-8 leading-relaxed max-w-[95%]">{brique.subtitle}</p>
        
        <div className="mt-auto flex items-center justify-between">
          <p className="text-sm font-semibold text-black/30 italic">"{brique.tagline}"</p>
